...
**禁止**调用 WebSearch / SearchGHSA / SearchGitHubIssues，只根据爬虫结果写文档。GHSA/公开公告标 patched；未关闭 Issue 默认 unpatched。未修复洞只来自 Issues。无关/安全政策帖不要建档。尚未分配 CVE 的 Issue 披露只要机制清楚、属于本项目即可收录。
